...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYS] = LAYOUT(KC_F12, KC_F7, KC_F8, KC_F9, KC_PSCR, XXXXXXX, QWERTY, ENGRAMISH, DF(_NAV), RESET, KC_F11, KC_F4, KC_F5, KC_F6, KC_SLCK, XXXXXXX, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_F10, KC_F1, KC_F2, KC_F3, KC_PAUS, XXXXXXX, DF(_SYM), DF(_NUM), KC_ALGR, XXXXXXX, L_NAV, L_NUM, L_SYM, L_MOU),
